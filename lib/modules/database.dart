...
class DataHelper {
  static Future<Database> datebae() async {
    ...
    return sql.openDatabase(path.join(datapath, 'image.db'),
        onCreate: (db, version) {
      return db.execute(
          'CREATE TABLE user_image(id TEXT PRIMARY KEY, title TEXT, image TEXT, size TEXT,des TEXT, distance TEXT, selectedType TEXT, natureType TEXT, materialType TEXT)');
    }, version: 1);
  }
