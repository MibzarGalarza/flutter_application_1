...
import 'package:flutter_application_1/widgits/my_input_screen.dart';
import 'package:flutter_application_1/modules/classes.dart' as ima;
...
class _MyHomePageState extends State<MyHomePage> {
  bool showCircularImages = false;

  String selectedNatureType = "";
                    ...
                    return Column(
                      children: [
                        ...
                        SingleChildScrollView(
                          ...
                          child: Row(
                            children: image.items
                                .where((item) =>
                                    item.selectedType ==
                                    'Sistema') // Filtra por el título 'Sistema'
                                .map((item) {
                              return Padding(
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    setState(() {
                                      // Cambia el estado para mostrar imágenes circulares solo si el natureType es igual
                                      showCircularImages = true;
                                      selectedNatureType = item.natureType;
                                    });
                                  },
                                  child: ClipRRect(
                        ...
                        if (showCircularImages)
                          SingleChildScrollView(
                            ...
                            child: Row(
                              children: image.items
                                  .where((item) =>
                                      item.selectedType != 'Sistema' &&
                                      item.natureType == selectedNatureType)
                                  .map((item) {
                                return Padding(
                                  padding: const EdgeInsets.all(16.0),
                                  child: GestureDetector(
