...
import 'package:flutter_application_1/widgits/image_input.dart';
import 'dart:io';
import 'package:provider/provider.dart';
import 'package:flutter_application_1/modules/classes.dart' as app_classes;
...
class _MyInputScreenState extends State<MyInputScreen> {
  ...
  String _natureType = 'Solar';
  String _materialType = 'Gas';
  ...
  List<String> _materialtypeOptions = [
    'Gas',
    'Liquido',
    'Rocoso',
  ];

  Map<String, String> _sistemastypeImages = {
    'Solar':
  ...
  final Map<String, String> _materialImages = {
    'Gas':
      ...
      body: Padding(
        ...
        child: SingleChildScrollView(
          child: Column(children: [
            ...
            if (_selectedType != 'Sistema')
              DropdownButton<String>(
                value: _materialType,
                items: _materialtypeOptions.map((String type) {
                  return DropdownMenuItem<String>(
                    value: type,
                    child: Padding(
                      padding: const EdgeInsets.all(5.0),
